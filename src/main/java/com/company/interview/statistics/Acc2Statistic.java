 ...
 */
public class Acc2Statistic implements Statistic {
    ...
    private LongAccumulator sum = new LongAccumulator(Math::addExact, 0);
    private LongAccumulator sum_sq = new LongAccumulator(Math::addExact, 0);
